...
namespace EternalModLoader
{
    ...
    public static class OnlineSafety
    {
        ...
        /// <summary>
        /// Horde Mode coin propitem decl without the scoringItem property
        /// </summary>
        private static byte[] s_hordeCoinScoreNullifier = new byte[]
        {
            
        };
        ...
        public static List<ResourceModFile> MultiplayerDisablerMod = new List<ResourceModFile>()
        {
            ...
            new ResourceModFile(s_parentMod, "generated/decls/propitem/propitem/horde/point_coin.decl", "e6m1_cult_horde", false)
            {
                FileData = new MemoryStream(s_hordeCoinScoreNullifier, 0, s_hordeCoinScoreNullifier.Length, false, true)
            },
            new ResourceModFile(s_parentMod, "generated/decls/propitem/propitem/horde/point_coin.decl", "e6m2_earth_horde", false)
            {
                FileData = new MemoryStream(s_hordeCoinScoreNullifier, 0, s_hordeCoinScoreNullifier.Length, false, true)
            },
            new ResourceModFile(s_parentMod, "generated/decls/propitem/propitem/horde/point_coin.decl", "e6m3_mcity_horde", false)
            {
                FileData = new MemoryStream(s_hordeCoinScoreNullifier, 0, s_hordeCoinScoreNullifier.Length, false, true)
            },
            // Localization
